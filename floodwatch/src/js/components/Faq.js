      ...
      <div id="faqpp">
        <Row className="section panel" id="faq">
          <Col className="panel-body">
            ...
            <h3 className="header">Does Floodwatch work with Adblock, Ghostery, etc.?</h3>
            ...
            <h3 className="header">Why am I being asked for my demographic information? Do I have to give any?</h3>
            ...
            <h3 className="header">What kinds of ads do you collect? Why aren’t I seeing more ads on the My Ads page?</h3>
            ...
            <h3 className="header">Why do I see other ads in my ad stream?</h3>
            ...
            <h3 className="header">Does Floodwatch plan to expand to other browsers?</h3>
            ...
            <h3 className="header">I found a bug! What should I do?</h3>
        ...
        <Row className="section panel" id="privacy">
          <Col className="panel-body">
            <h1 className="centered">Privacy Policy</h1>
            <h3 className="header">What are the risks in offering up my demographic or advertising information?</h3>
            ...
            <h3 className="header">What ad information do you collect?</h3>
            ...
            <h3 className="header">Wait, so if you see my browsing, can you see my bank account/social media/personal email, etc.?</h3>
            ...
            <h3 className="header">How do you use my information? Who can see it?</h3>
