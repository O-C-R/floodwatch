      ...
      <Col xs={10} xsOffset={1} md={8} mdOffset={2} id="faqpp">
        <div className="panel">
          <div className="panel-body">
            ...
            <h3 className="header"><a className="anchor" name="adblock">How does Floodwatch classify ads?</a></h3>
            <p>We use machine learning to power the ad classification in Floodwatch v2. We took the collected ads from v1, hand-categorized them according to Google Adwords categories, and then trained a neural network on these categorized ads. To categorize your ads, we run your ad images through this neural network, and the neural network makes its best guess as to what category your ad falls into. </p>
