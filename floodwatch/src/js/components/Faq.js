		...
		return (
			...
			<Row id="faq">
				<Col>
					...
					<h5 className="header"><a name="adblock">Does Floodwatch work with Adblock, Ghostery, etc.?</a></h5>
					...
					<h5 className="header"><a name="info">Why am I being asked for my demographic information? Do I have to give any?</a></h5>
					...
					<p>For many other factors, however, this practice is not only unethical, but illegal: for example, Facebook allowing advertisers to exclude certain races from particular job and housing postings (as shown by Propublica here). </p>
					...
					<p>Jump to our <a href="#privacy">Privacy Policy</a> to learn more about the risks of providing personal information to anyone, and to see how Floodwatch protects your data.</p>


					<h5 className="header"><a name="adtypes">What kinds of ads do you collect? Why aren’t I seeing more ads on the My Ads page?</a></h5>
					...
					<p>If you’re not seeing any ads displayed on your History page, please first try browsing for a little longer, before reporting a bug on our public Github repository, or contacting us at floodwatch@o-c-r.org.</p>


					<h5 className="header"><a name="otherads">Why do I see other ads in my ad stream?</a></h5>
					...
					<h5 className="header"><a name="browsers">Does Floodwatch plan to expand to other browsers?</a></h5>
					...
					<p>The Floodwatch extension is open source, so if you’re interested in porting Floodwatch to other browsers, feel free to fork it.</p>


					<h5 className="header"><a name="bugs">I found a bug! What should I do?</a></h5>
					<p>We’re working hard to fix bugs and make improvements. Email us at floodwatch@ocr.nyc to report it, or check the Issues list on our Github repository, where you can see if the bug has already been filed or file a new one.</p>
			...
			<Row id="privacy">
				...
				<h5 className="header"><a name="risks">What are the risks in offering up my demographic or advertising information?</a></h5>
...
<ul>
<li>In 2000, Latanya Sweeney demonstrated that 87% of the US population could be uniquely identified with just their zip code, gender, and date of birth. (Source.)</li>
<li>In 2008, Narayanan and Shmatikov were able to use de-anonymization techniques to re-identify 500,000 Netflix subscribers, where the dataset only included dates and movie ratings. (Source.)</li>
</ul>
</p>
...
<p>Floodwatch has several security mechanisms in place to make sure your data is as safe as possible and controllable by you:
...
<li>We keep your data secure through the security industry’s best practices. Want to see exactly how our extension code works? It’s open source: check it out here.</li>
...
<p>Still have questions? Send them to floodwatch@ocr.nyc.</p>


<h5 className="header"><a name="adinfo">What ad information do you collect?</a></h5>
...
<h5 className="header"><a name="browsing">Wait, so if you see my browsing, can you see my bank account/social media/personal email, etc.?</a></h5>
<p>Nope! Floodwatch very deliberately tries to avoid collecting this info in a few ways:
<ul>
...
<h5 className="header"><a name="visibility">How do you use my information? Who can see it?</a></h5>
...
<h5 className="header"><a name="export">Can I see my records?</a></h5>
<p>Sure! Go to your profile and click the Export Data option.</p>


<h5 className="header"><a name="delete">Can I delete my records?</a></h5>
<p>Of course! Same process as above, except click the Delete Account option.</p>


<h5 className="header"><a name="policychanges">Changes to policy</a></h5>
<p>There is a possibility that we might need to adapt our Privacy Policy in the future, to clarify or modify it in response to our needs and your feedback. Please check the FAQ periodically for changes. We will still do our best to notify you of any major changes to our policy, and your continued use of Floodwatch will mean you accept them.</p>
