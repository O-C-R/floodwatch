...
export class Faq extends Component {
  render() {
    return (
      <div id="faqpp" className="faq">
        <div className="container">
          <h1>FAQ</h1>

          <h2><a name="adblock">Does Floodwatch work with Adblock, Ghostery, etc.?</a></h2>
          ...
          <h2><a name="info">Why am I being asked for my demographic information? Do I have to give any?</a></h2>
          ...
          <h2><a name="adtypes">What kinds of ads do you collect? Why aren’t I seeing more ads on the My Ads page?</a></h2>
          ...
          <h2><a name="otherads">Why do I see other ads in my ad stream?</a></h2>
          ...
          <h2><a name="browsers">Does Floodwatch plan to expand to other browsers?</a></h2>
          ...
          <h2><a name="bugs">I found a bug! What should I do?</a></h2>
          ...
          <h1><a name="privacy">Privacy Policy</a></h1>
          <h2><a name="risks">What are the risks in offering up my demographic or advertising information?</a></h2>
          ...
          <h2><a name="adinfo">What ad information do you collect?</a></h2>
          ...
          <h2><a name="browsing">Wait, so if you see my browsing, can you see my bank account/social media/personal email, etc.?</a></h2>
          ...
          <h2><a name="visibility">How do you use my information? Who can see it?</a></h2>
